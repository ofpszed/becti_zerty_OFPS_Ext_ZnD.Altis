...
switch (true) do {
	...
	case (_value > 200 && _value <= 250) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 55], ["SOLDIERS_AT_MEDIUM", 2, 65], ["SOLDIERS_AT_HEAVY", 2, 65], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 85]], [["VEHICLES_LIGHT", 1, 37], ["VEHICLES_MEDIUM", 1, 35], ["VEHICLES_HEAVY", 2, 30], ["VEHICLES_AA_LIGHT", 1, 27]]];
	};
	case (_value > 250 && _value <= 300) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 50], ["SOLDIERS_AT_MEDIUM", 2, 70], ["SOLDIERS_AT_HEAVY", 2, 70], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 90]], [["VEHICLES_LIGHT", 1, 35], ["VEHICLES_MEDIUM", 1, 37], ["VEHICLES_HEAVY", 2, 33], ["VEHICLES_AA_LIGHT", 1, 30]]];
	};
	case (_value > 300 && _value <= 350) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 45], ["SOLDIERS_AT_MEDIUM", 2, 75], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 95]], [["VEHICLES_LIGHT", 1, 33], ["VEHICLES_MEDIUM", 1, 40], ["VEHICLES_HEAVY", 2, 35], ["VEHICLES_AA_LIGHT", 1, 30]]];
	};
	case (_value > 350 && _value <= 400) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 40], ["SOLDIERS_AT_MEDIUM", 1, 80], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 1, 33], ["VEHICLES_MEDIUM", 2, 40], ["VEHICLES_HEAVY", 2, 37], ["VEHICLES_AA_LIGHT", 1, 30]]];
	};
	case (_value > 400 && _value <= 450) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 37], ["SOLDIERS_AT_MEDIUM", 1, 82], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 1, 30], ["VEHICLES_MEDIUM", 2, 42], ["VEHICLES_HEAVY", 3, 40], ["VEHICLES_AA_LIGHT", 2, 30]]];
	};
	case (_value > 450 && _value <= 500) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 35], ["SOLDIERS_AT_MEDIUM", 1, 84], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 2, 27], ["VEHICLES_MEDIUM", 3, 45], ["VEHICLES_HEAVY", 4, 42], ["VEHICLES_AA_LIGHT", 3, 30]]];
	};
	case (_value > 500) : {
