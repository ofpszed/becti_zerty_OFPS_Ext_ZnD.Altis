...
/*****Wind Farm START****/
_pos = [2257.551514,15760.255859,152.267];
_object = createVehicle ["Land_Cargo_Tower_V2_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;

_pos = [2257.356934,15760.760742,143.22];
_object = createVehicle ["Land_VR_Block_04_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;
_pos = [2267.727295,15760.762695,143.666];
_object = createVehicle ["Land_VR_Block_04_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;
_pos = [2246.982666,15760.764648,143.491];
_object = createVehicle ["Land_VR_Block_04_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;
_pos = [2257.423584,15771.161133,143.549];
_object = createVehicle ["Land_VR_Block_04_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;
_pos = [2257.365479,15750.388672,143.271];
_object = createVehicle ["Land_VR_Block_04_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;

_pos = [2258.0559082,15759.814453,175.956];
_object = createVehicle ["Windsock_01_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;

_pos = [2261.141113,15764.660156,170.318];
_object = createVehicle ["Land_PortableLight_double_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 360;
_object setPosATL _pos;

_pos = [2266.206299,15762.0166016,145.341];
_object = createVehicle ["Land_LampAirport_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 89.9999;
_object setPosATL _pos;

_pos = [2249.283691,15760.128906,144.682];
_object = createVehicle ["Land_LampAirport_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 269;
_object setPosATL _pos;

_pos = [2321.584961,15786.866211,-0.305626];
_object = createVehicle ["Land_wpp_Turbine_V2_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosASL _pos;
...
_object setDir 0;
_object setPosATL _pos;
_pos = [2258.157715,15760.201172,171.555];
_object = createVehicle ["Flag_ION_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;
