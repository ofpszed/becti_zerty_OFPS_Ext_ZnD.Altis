/*
  # HEADER #
	Script: 		Common\Functions\Common_GetRandomPositionWater.sqf
	Alias:			CTI_CO_FNC_GetRandomPositionWater
  ...
  # SYNTAX #
	[CENTER, RADIUS MIN, RADIUS MAX] call CTI_CO_FNC_GetRandomPositionWater

  # EXAMPLE #
    _position = [player, 25, 150] call CTI_CO_FNC_GetRandomPositionWater
