...
/*
	Specials:
		- DMG_Alternative: Need to be used in case of boisterous buildings usage
				If a building is damaged, all the EH it had will mysteriously vanish... This "feature" will probably never get fixed so once again, we fix it ourself!
