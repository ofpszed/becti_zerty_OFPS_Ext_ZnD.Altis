...
_c = _c + ['M1126_ICV_M134_DG1_SLATWOOD'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [6000];
_t = _t + [25];
...
_c = _c + ['M1126_ICV_mk19_DG1_SLATWOOD'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [6000];
_t = _t + [25];
...
_c = _c + ['M1135_ATGMV_DG1_SLATWOOD'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [8000];
_t = _t + [25];
