...
with missionNamespace do {
	...
	CTI_PVF_Client_OnSpecialConstructed = {
		...
		_fob addAction ["<t color='#e67b09'>FOB: Buy Motorcycle (150$)</t>","Addons\Strat_mode\Functions\SM_Action_Buy_Town.sqf", ["CUP_M1030",150,true], 99, false, true, "", " !CTI_P_PreBuilding && vehicle player == player"];
